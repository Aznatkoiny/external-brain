...
Read `system/protocol.md`, `system/schema.md`, `system/relationships.md`, and `skills/obsidian-markdown/SKILL.md`.
...
5. Move possible contradictions, ambiguous merges, and vocabulary changes to `system/review-queue.md`. Only the user confirms these judgments.
...
7. Append a `maintain` entry to `system/log.md`, update affected timestamps, and rerun the linter.
